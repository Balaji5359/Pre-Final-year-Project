                        ...
                        <>
                            {chat.length === 0 && (
                                <div className="welcome-message">
                                    <p style={{ fontSize: '17px' }}>👋 Hello! I'm your GenAI Agent.<br />I will conduct JAM session for you.</p>
                                </div>
                            )}
                            {chat.map((msg, i) => (
                                <div key={i} className={`chat-message ${msg.sender}`}>
                ...
                {(
                    ...
                    <div className="instructions-panel">
                        ...
                        <ul>
                            ...
                            <li> * Agent will provide topic to speak, if you know topic
                                then speak on that topic for 1 minute</li>
