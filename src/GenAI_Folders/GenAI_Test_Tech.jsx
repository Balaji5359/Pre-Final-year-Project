            ...
            <div className="main-container">
                        ...
                        <>
                            {chat.length === 0 && (
                                <div className="welcome-message">
                                    <p style={{ fontSize: '17px' }}>👋 Hello! I'm your GenAI Agent.<br />I am here to test you in your Field.</p>
                                </div>
                            )}
                            {chat.map((msg, i) => (
                                <div key={i} className={`chat-message ${msg.sender}`}>
                ...
                {(
                    ...
                    <div className="instructions-panel">
                        <h3>Field Test Session Instructions</h3>
                        <ul>
                            <li> * Give greetings to Agent as "hi", to start test</li>
                            <li> * Speak clearly and at a moderate pace</li>
                            <li> * Be honest and authentic in your responses</li>
                            <li> * Use voice or text to communicate</li>
                            <li> * Take your time to think before starting answer</li>
...
export default GenAI_Test_Tech;