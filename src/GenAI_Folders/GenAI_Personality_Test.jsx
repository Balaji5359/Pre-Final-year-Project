...
function GenAI_Personality_Test() {
                        ...
                        <>
                            {chat.length === 0 && (
                                <div className="welcome-message">
                                    <p style={{ fontSize: '17px' }}>👋 Hello! I'm your GenAI Agent.<br />I am here to test you mentality and personality.</p>
                                </div>
                            )}
                            {chat.map((msg, i) => (
                                <div key={i} className={`chat-message ${msg.sender}`}>
...
export default GenAI_Personality_Test;